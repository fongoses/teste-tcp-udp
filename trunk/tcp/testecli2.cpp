...
#define PORTA_CLI 3345 // porta TCP do cliente
#define PORTA_SRV 3023 // porta TCP do servidor
#define STR_IPSERVIDOR "127.0.0.1"
//#define STR_IPSERVIDOR "192.168.0.146"
#define TAXA 100000 //taxa de transferencia, em Kbit/s
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    ...
    /* Aguarda usuario digitar mensagem
